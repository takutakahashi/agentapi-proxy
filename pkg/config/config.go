...
type KubernetesSessionConfig struct {
	...
	// container and the network-filter sidecar. Defaults to ghcr.io/takutakahashi/nfa:v0.12.1.
...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("kubernetes_session.network_filter_image", "ghcr.io/takutakahashi/nfa:v0.12.1")
